...
export const carouselNext = tv({
  base: [
    ...
    "group-data-[axis=x]/carousel:top-1/2 group-data-[axis=x]/carousel:right-2 group-data-[axis=x]/carousel:-translate-y-1/2 sm:group-data-[axis=x]/carousel:-right-12",
...
export const carouselPrevious = tv({
  base: [
    "absolute size-8 rounded-full",
    "group-data-[axis=x]/carousel:top-1/2 group-data-[axis=x]/carousel:left-2 group-data-[axis=x]/carousel:-translate-y-1/2 sm:group-data-[axis=x]/carousel:-left-12",
