...
describe('project configuration', () => {
  ...
  it.each([
    [{ name: 'Missing template', slug: 'missing-template', theme: 'brand', pages: ['home'] }],
    [{ name: 'Missing theme', slug: 'missing-theme', template: 'structure', pages: ['home'] }],
    [{ name: 'Bad slug', slug: 'Bad Slug', template: 'structure', theme: 'brand', pages: ['home'] }],
